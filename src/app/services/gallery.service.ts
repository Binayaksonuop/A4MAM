...
export class GalleryService {
  private storageKey = 'a4mam_gallery_images_v2';
  ...
  private getMockImages(): GalleryImage[] {
    ...
    return [
      ...
      { id: 'IMG-013', url: base + 'mam_gallery_1.jpg', title: 'Rural Mission', location, description: 'On-ground execution of MAM protocols.', category: 'Outreach', date: new Date() },
      { id: 'IMG-014', url: base + 'mam_gallery_2.jpg', title: 'Field Intervention', location, description: 'Direct nutritional support delivery.', category: 'Intervention', date: new Date() },
      { id: 'IMG-015', url: base + 'mam_gallery_3.jpg', title: 'Health Metrics', location, description: 'Measuring impact with precision.', category: 'Field Data', date: new Date() },
      { id: 'IMG-016', url: base + 'mam_gallery_4.jpg', title: 'Product Showcase', location, description: 'Our range of Spirulina-based solutions.', category: 'Production', date: new Date() },
      { id: 'IMG-017', url: base + 'mam_gallery_5.jpg', title: 'Community Connect', location, description: 'Building trust in rural Odisha.', category: 'Outreach', date: new Date() },
      { id: 'IMG-018', url: base + 'mam_gallery_6.jpg', title: 'Scaling Impact', location, description: 'Expanding our reach across the state.', category: 'Impact', date: new Date() },
      { id: 'IMG-019', url: base + 'mam_gallery_7.jpg', title: 'Operational Excellence', location, description: 'Streamlined delivery systems.', category: 'Intervention', date: new Date() },
      { id: 'IMG-020', url: base + 'mam_gallery_8.jpg', title: 'Scientific Rigor', location, description: 'Evidence-based nutritional science.', category: 'Field Data', date: new Date() },
      { id: 'IMG-021', url: base + 'mam_gallery_9.jpg', title: 'Mission Growth', location, description: 'Scaling to new horizons.', category: 'Awareness', date: new Date() },
      { id: 'IMG-022', url: base + 'mam_gallery_10.jpg', title: 'Success Stories', location, description: 'Real lives transformed by A4MAM.', category: 'Impact', date: new Date() },
      { id: 'IMG-023', url: base + 'mam_gallery_11.jpg', title: 'Local Partnership', location, description: 'Collaborating for a malnutrition-free India.', category: 'Awareness', date: new Date() }
    ];
  }
}
